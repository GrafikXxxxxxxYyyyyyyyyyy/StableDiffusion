...
class TextEncoderModel:
    """
    Данный класс представляет собой обёртку над моделью CLIPTextEncoder
    И по идее предоставляет функционал для загрузки лор в модель
    """
    def __init__(
        self,
        model_path: str,
        ...
        # Инициализируем модели в зависимости от архитектуры
        if model_type == "sd15":
    ...
    # TODO: Подумать над тем, как можно включать/выключать лоры
    def load_loras(self):
        pass
